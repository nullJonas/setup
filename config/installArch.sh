...
echo "\e[1;36m Ativa sincronização do relógio \e[m"
timedatectl set-ntp true

# Particiona o disco
echo "\e[1;36m Particiona o disco \e[m"
...
echo "\e[1;36m Formata as partições \e[m"
mkfs.fat -F 32 "$DEVICE""$PRE"1
mkswap "$DEVICE""$PRE"2
mkfs.ext4 "$DEVICE""$PRE"3

# Monta as partições
echo "\e[1;36m Monta as partições \e[m"
mount "$DEVICE""$PRE"3 /mnt
mkdir /mnt/boot
mount "$DEVICE""$PRE"3 /mnt/boot

# Liga o swap
echo "\e[1;36m Liga o swap \e[m"
swapon "$DEVICE""$PRE"2

# Seleciona os mirrors mais rápidos para download
echo "\e[1;36m Seleciona os mirrors mais rápidos para download \e[m"
...
echo "\e[1;36m Instala o kernel e pacotes básicos \e[m"
pacstrap /mnt base base-devel linux linux-firmware

# Gera o arquivo fstab
echo "\e[1;36m Gera o arquivo fstab \e[m"
genfstab -U /mnt >> /mnt/etc/fstab

# Faz o chroot
echo "\e[1;36m Faz o chroot \e[m"
arch-chroot /mnt

# Configura o idioma e o fuso horário
echo "\e[1;36m Configura o idioma e o fuso horário \e[m"
...
# Configura a rede
echo "\e[1;36m Configura a rede \e[m"
