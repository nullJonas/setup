...
echo "\033[1;36m Ativa sincronização do relógio \033[m"
timedatectl set-ntp true

# Particiona o disco
echo "\033[1;36m Particiona o disco \033[m"
...
echo "\033[1;36m Formata as partições \033[m"
mkfs.fat -F 32 "$DEVICE""$PRE"1
mkswap "$DEVICE""$PRE"2
mkfs.ext4 "$DEVICE""$PRE"3

# Monta as partições
echo "\033[1;36m Monta as partições \033[m"
mount "$DEVICE""$PRE"3 /mnt
mkdir /mnt/boot
mount "$DEVICE""$PRE"1 /mnt/boot

# Liga o swap
echo "\033[1;36m Liga o swap \033[m"
swapon "$DEVICE""$PRE"2

# Seleciona os mirrors mais rápidos para download
echo "\033[1;36m Seleciona os mirrors mais rápidos para download \033[m"
...
echo "\033[1;36m Instala o kernel e pacotes básicos \033[m"
pacstrap /mnt base base-devel linux linux-firmware

# Gera o arquivo fstab
echo "\033[1;36m Gera o arquivo fstab \033[m"
genfstab -U /mnt >> /mnt/etc/fstab

# Faz o chroot
echo "\033[1;36m Faz o chroot \033[m"
arch-chroot /mnt

# Configura o idioma e o fuso horário
echo "\033[1;36m Configura o idioma e o fuso horário \033[m"
...
# Configura a rede
echo "\033[1;36m Configura a rede \033[m"
